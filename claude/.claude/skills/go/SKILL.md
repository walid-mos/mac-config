...
8. **No commit and no push after Phase 7.** See the **Commit + push policy** in the state-marker section near the top. The dirty working tree is the contract; do not commit "to lock it in".
