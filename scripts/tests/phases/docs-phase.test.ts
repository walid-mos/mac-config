...
import { runDocsPhase } from '../../src/phases/docs-phase.js'
import type { SessionContext, SessionId, SwarmState } from '../../src/types.js'
...
vi.mock('../../src/phase-results.js', async (importOriginal) => {
