...
| Token | OKLCH | Typical usage |
|---|---|---|
| `--color-base-50`  | `oklch(98.4% 0.003 247.86)` | Page background (light) |
| `--color-base-100` | `oklch(96.8% 0.007 247.84)` | Subtle surfaces / soft border |
| `--color-base-200` | `oklch(92.9% 0.013 255.51)` | Borders |
| `--color-base-300` | `oklch(86.9% 0.022 252.89)` | Mid borders |
| `--color-base-400` | `oklch(70.4% 0.04 256.79)`  | Dark-mode muted text |
| `--color-base-500` | `oklch(55.4% 0.046 257.42)` | Muted text |
| `--color-base-600` | `oklch(44.6% 0.043 257.28)` | — |
| `--color-base-700` | `oklch(37.2% 0.044 257.29)` | Dark-mode borders |
| `--color-base-800` | `oklch(27.9% 0.041 260.03)` | Dark-mode surfaces |
| `--color-base-900` | `oklch(20.8% 0.042 265.76)` | Primary text (light) / page bg (dark) |
| `--color-base-950` | `oklch(12.9% 0.042 264.7)`  | — |
