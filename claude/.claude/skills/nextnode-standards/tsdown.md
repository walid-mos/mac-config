...
- `target: 'es2023'` - note: the TypeScript configs moved to ES2024 in standards 1.10.0 but the tsdown base still targets es2023; bundle output is slightly more conservative than type-checking.
