...
3. **Implement in place**, with a behavior lock:
   - everything → implement directly, one verifiable step per turn
...
- cron → rien d'intégré pour l'instant ; dire que ce n'est pas couvert
