---
name: tdd
description: Test-Driven Development workflow using vertical slices and tracer bullets. Use when user wants to build a feature using TDD, or invokes /tdd. Complements the vitest skill (test standards) with the TDD methodology (workflow).
user-invocable: true
---
