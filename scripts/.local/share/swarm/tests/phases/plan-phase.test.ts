...
import { runPlanPhase } from '../../src/phases/plan-phase.js'
import type { PlanPhaseResult } from '../../src/phase-results.js'
import type { SessionContext, SessionId, ModelId, SwarmState, SwarmStateManager, SwarmEvent } from '../../src/types.js'
...
vi.mock('../../src/tech-stack.js', () => ({
  detectTechStack: vi.fn(),
}))

vi.mock('../../src/prompts/planner-prompt.js', () => ({
  buildPlannerPrompt: vi.fn(),
}))

vi.mock('../../src/task-parser.js', () => ({
...
import { parseTaskDecomposition } from '../../src/task-parser.js'
