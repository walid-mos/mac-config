...
export function readAuthField(provider: string, field: string): string | undefined {
...
export async function fetchJson(url: string, token: string): Promise<unknown | undefined> {
